    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-emerald-950 via-teal-900 to-emerald-900 px-4 py-8">
      <div className="w-full max-w-md bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold text-gray-900 bg-gradient-to-r from-emerald-600 to-teal-500 bg-clip-text text-transparent capitalize">
            Customer Sign In
          </h2>
          <p className="mt-2 text-sm text-gray-500">
            Sign in to your account at <strong className="text-gray-700 capitalize">{slug}</strong>
          </p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-500 space-y-2 flex flex-col items-center">
          <span>New customer at this store?</span>
          <Link
            to={redirectUrl ? `/store/${slug}/register?redirect=${encodeURIComponent(redirectUrl)}` : `/store/${slug}/register`}
